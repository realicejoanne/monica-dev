...
//    int widthImage = 50;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbox_1.setTypeface(ResourcesCompat.getFont(this, R.font.josefinsans_regular));
        cbox_2 = (CheckBox) findViewById(R.id.cbox_2);
        cbox_2.setTypeface(ResourcesCompat.getFont(this, R.font.josefinsans_regular));
        cbox_3 = (CheckBox) findViewById(R.id.cbox_3);
        cbox_3.setTypeface(ResourcesCompat.getFont(this, R.font.josefinsans_regular));
